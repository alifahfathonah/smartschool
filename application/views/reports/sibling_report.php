							...
							<table class="table table-striped table-bordered table-hover example">
								...
								<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<?php  foreach($student as $value){ echo $value['class'] . " (" . $value['section'] . ")<br>";   } ?></td>
										<?php if ($sch_setting->admission_date) {  ?>
                                        <td>
                                            <?php foreach($student as $value){      
												if (!empty($value['admission_date'])) { echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['admission_date']))."<br>";
                                                     }   } ?> <?php  ?></td>
										<?php } ?>
                                        <td>
                                            <?php foreach($student as $value){
												if (!empty($value['gender'])) { echo $value['gender']."<br>"; } } ?>
                                        </td>
                                    </tr>
                                    <?php $count++;
                                            }
