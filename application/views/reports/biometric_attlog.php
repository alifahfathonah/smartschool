                    ...
                    <table class="table table-striped table-bordered table-hover example">
                       <thead>
                            <tr>
								...
								<th><?php echo $this->lang->line('device')." ".$this->lang->line('mac'); ?></th>
                                    ...
                                    <?php
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $logs) {
                                                ...
                                                <tr>
                                                <?php if(!$adm_auto_insert){ ?>
                                                <td> <?php if(!empty($device_info)){  echo $device_info->user_id; }?></td> <?php } ?>
                                                <td><?php echo $logs['name']; ?></td>
                                                <td><?php if(!empty($device_info)){  echo date($this->customlib->getSchoolDateFormat(true,true),strtotime($device_info->t)); }?></td>
                                                <td><?php if(!empty($device_info)){  echo $device_info->serial_number; }?></td>
                                                <td><?php if(!empty($device_info)){  echo $device_info->mac; }?></td>
                                                <td><?php if(!empty($device_info)){  echo $device_info->ip; }?></td>
                                            </tr>
                                                <?php
                                                $count++;
                                            }
