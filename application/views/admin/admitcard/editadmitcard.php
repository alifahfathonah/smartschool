                        ...
                        <form  enctype="multipart/form-data" action="<?php echo site_url('admin/admitcard/edit/'.$admitcard->id) ?>"  id="editform" name="editform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('heading');?></label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label><?php  echo $this->lang->line('exam')." ".$this->lang->line('name')?></label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('exam')." ".$this->lang->line('center')?><small class="req"> *</small></label>
                                    <input autofocus="" id="exam_center" name="exam_center" placeholder="" type="text" class="form-control" value="<?php echo set_value('template',$admitcard->template);?>"/>
                                    <span class="text-danger"><?php echo form_error('exam_center'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('left')." ".$this->lang->line('logo')?></label>
                                    <input id="documents" name="left_logo" placeholder="" type="file" class="filestyle form-control" data-height="28"  name="background_image">
                                    <span class="text-danger"><?php echo form_error('left_logo'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('right')." ".$this->lang->line('logo'); ?></label>
                                    <input id="documents" name="right_logo" placeholder="" type="file" class="filestyle form-control" data-height="28"  name="background_image">
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('backgroud')." ".$this->lang->line('image'); ?></label>
