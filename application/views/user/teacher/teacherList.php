                                            ...
                                            <tr>
                                               ...
                                               if(isset($reviews[$teacher[0]->staff_id])){
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    if($reted=='0'){ ?>
                                                    <a class="btn btn-default btn-xs" onclick="rating('<?php echo $teacher[0]->staff_id?>')" data-toggle="tooltip" title=""  data-original-title="Add" ><i class="fa fa-plus"></i></a><?php } ?></td>
                                            </tr>
                                            <?php
                                        }
                                        $count++;
