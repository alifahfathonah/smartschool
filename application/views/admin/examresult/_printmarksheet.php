                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td valign="top" align="center"><img src="<?php echo base_url('uploads/marksheet/' . $template->left_logo); ?>" width="100" height="100"> </td>
                                        <td valign="top">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" class="">
                                        ...
                                        <tr>
                                            ...
                                            if ($template->is_photo) {
                                                ?>
                                                <td valign="top" align="center"><img src="<?php echo base_url() . $student_value['image']; ?>" width="100" height="100">
                                                </td>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <td valign="top">
                                        <table cellpadding="0" cellspacing="0" width="100%" class="">
                                            <tr>
                                                ...
                                                if ($template->is_photo) {
                                                    ?>
                                                    <td valign="top" align="center"><img src="<?php echo base_url() . $student_value['image']; ?>" width="120" height="150" style="border: 2px solid #fff;
...
// print_r($marksheet['exams']);
                                                        ...
                                                        ?>
                                                        <th valign="top" style="text-align: left;border-right:1px solid #999"><?php  echo $this->lang->line('consolidate')?><?php echo $this->lang->line('consolidate');?></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
