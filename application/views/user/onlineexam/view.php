                        ...
                        if (!empty($online_exam_validate)) {
                            ...
                            <dl class="row">
                                ...
                                if (!empty($result_prepare) && ($exam->publish_result)) {
                                    ...
                                    <dt class="col-sm-3 col-md-2 "><?php echo $this->lang->line('correct')." ".$this->lang->line('answer');?></dt>
                                    <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo $correct_ans; ?></dd>

                                    <dt class="col-sm-3 col-md-2"><?php  echo $this->lang->line('wrong')." ".$this->lang->line('answer')?></dt>
                                    <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo $wrong_ans; ?></dd>

                                    <dt class="col-sm-3 col-md-2"><?php  echo $this->lang->line('score')?> (%) </dt>
                                    <dd class="col-sm-9 col-xs-8 col-md-10"><?php echo ($correct_ans * 100) / $total_question."%"; ?></dd>
                            ...
                            <?php
                            if (!empty($question_result) && !empty($result_prepare) && ($exam->publish_result)) {
                                foreach ($question_result as $result_key => $question_value) {
                                    ?>
...
<script type="text/javascript">
    ...
    function get_elapsed_time_string() {
        ...
        if ((seconds <= 0) && (minutes <= 0) && (hours <= 0)) {
            clearInterval(interval);
            $("#regiration_form").submit(); // Submit the form
        }
