                                        ...
                                        foreach($resultlist as $value){?>
                                           ...
                                           <span style="display:none;" id="ratevalue"> <?php echo  $value['rate'] ; ?></span>
                                            ...
                                            if($this->rbac->hasPrivilege('teachers_rating','can_edit')){
                                                ...
                                                if($value['status']=='0'){ ?><a class="" href="<?php echo base_url();?>admin/Staff/ratingapr/<?php echo $value['rate_id']?>"><small class="label label-info"><?php echo $this->lang->line('approve'); ?></small></a><?php }else{ ?><?php } } 
