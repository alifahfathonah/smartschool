...
?>
    ...
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-3 control-label"><?php echo "Total Amount"; ?></label>
        <div class="col-sm-9">
            <input id="total_amount" name="total_amount" placeholder="<?php echo number_format((float) $total_amount, 2, '.', ''); ?>" type="text" class="form-control" value="" readonly="readonly" autocomplete="off">
            <span id="form_collection_collected_date_error" class="text text-danger"></span>
        </div>
    </div>
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-3 control-label"><?php echo "Discount Group"; ?></label>
        <div class="col-sm-9">
     ...
     <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo "Discount"; ?><small class="req"> *</small></label>
                            <div class="col-sm-9">
                              <div class="row">  
                                ...
                                <div class="col-md-2 col-sm-2 ltextright">
                                    ...
                                    <label for="inputPassword3" class="control-label"><?php echo "Fine"; ?><small class="req">*</small></label>
                                </div>
                                <div class="col-md-5 col-sm-5">
                                    <div class="">
